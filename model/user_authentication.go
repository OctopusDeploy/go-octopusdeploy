...
// GetID returns the ID value of the UserAuthentication.
func (resource UserAuthentication) GetID() string {
	return resource.ID
}

// GetLastModifiedBy returns the name of the account that modified the value of this UserAuthentication.
func (resource UserAuthentication) GetLastModifiedBy() string {
	return resource.LastModifiedBy
}

// GetLastModifiedOn returns the time when the value of this UserAuthentication was changed.
func (resource UserAuthentication) GetLastModifiedOn() *time.Time {
	return resource.LastModifiedOn
}

// GetLinks returns the associated links with the value of this UserAuthentication.
func (resource UserAuthentication) GetLinks() map[string]string {
	return resource.Links
}

// Validate checks the state of the UserAuthentication and returns an error if invalid.
