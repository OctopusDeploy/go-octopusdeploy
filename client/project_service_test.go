...
func CreateTestProject(t *testing.T, service *projectService, lifecycle *model.Lifecycle, projectGroup *model.ProjectGroup) *model.Project {
	if service == nil {
	...
	project := model.NewProject(name, lifecycle.GetID(), projectGroup.GetID())
...
func DeleteTestProject(t *testing.T, service *projectService, project *model.Project) error {
	if service == nil {
		service = createProjectService(t)
	}
	require.NotNil(t, service)
