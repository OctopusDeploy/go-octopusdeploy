...
func CreateTestSpace(t *testing.T, service *spaceService) *model.Space {
	if service == nil {
...
func DeleteTestSpace(t *testing.T, service *spaceService, space model.Space) error {
...
func IsEqualSpaces(t *testing.T, expected *model.Space, actual *model.Space) {
...
func UpdateTestSpace(t *testing.T, service *spaceService, space *model.Space) *model.Space {
	if service == nil {
		service = createSpaceService(t)
	}
	require.NotNil(t, service)
...
func TestSpaceSetAddGetDelete(t *testing.T) {
	...
	resource, err = service.Add(&model.Space{})
	require.Error(t, err)
	require.Nil(t, resource)
...
func TestSpaceServiceUpdate(t *testing.T) {
	...
	resource, err = service.Update(&model.Space{})
	require.Error(t, err)
	require.Nil(t, resource)
