...
func CreateTestTeam(t *testing.T, service *teamService) *model.Team {
	if service == nil {
...
func DeleteTestTeam(t *testing.T, service *teamService, team model.Team) error {
...
func IsEqualTeams(t *testing.T, expected *model.Team, actual *model.Team) {
...
func UpdateTeam(t *testing.T, service *teamService, team *model.Team) *model.Team {
	if service == nil {
		service = createTeamService(t)
	}
	require.NotNil(t, service)
...
func TestTeamSetAddGetDelete(t *testing.T) {
	...
	resource, err = service.Add(&model.Team{})
	require.Error(t, err)
	require.Nil(t, resource)
...
func TestTeamServiceUpdate(t *testing.T) {
	...
	resource, err = service.Update(&model.Team{})
	require.Error(t, err)
	require.Nil(t, resource)
