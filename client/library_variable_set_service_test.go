...
func CreateTestLibraryVariableSet(t *testing.T, service *libraryVariableSetService) *model.LibraryVariableSet {
	if service == nil {
...
func DeleteTestLibraryVariableSet(t *testing.T, service *libraryVariableSetService, libraryVariableSet *model.LibraryVariableSet) error {
...
func IsEqualLibraryVariableSets(t *testing.T, expected *model.LibraryVariableSet, actual *model.LibraryVariableSet) {
...
func UpdateLibraryVariableSet(t *testing.T, service *libraryVariableSetService, libraryVariableSet *model.LibraryVariableSet) *model.LibraryVariableSet {
	if service == nil {
		service = createLibraryVariableSetService(t)
	}
	require.NotNil(t, service)
...
func TestLibraryVariableSetServiceSetAddGetDelete(t *testing.T) {
	...
	resource, err = service.Add(&model.LibraryVariableSet{})
	require.Error(t, err)
	require.Nil(t, resource)
...
func TestLibraryVariableSetServiceUpdate(t *testing.T) {
	...
	resource, err = service.Update(&model.LibraryVariableSet{})
	require.Error(t, err)
	require.Nil(t, resource)
