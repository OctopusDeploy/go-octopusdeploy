...
func CreateTestLifecycle(t *testing.T, service *lifecycleService) *model.Lifecycle {
	if service == nil {
...
func DeleteTestLifecycle(t *testing.T, service *lifecycleService, lifecycle *model.Lifecycle) error {
	require.NotNil(t, lifecycle)
...
func TestLifecycleServiceAdd(t *testing.T) {
	...
	resource = model.NewLifecycle(getRandomName())
