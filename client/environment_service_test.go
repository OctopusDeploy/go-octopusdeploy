...
func CreateTestEnvironment(t *testing.T, service *environmentService) *model.Environment {
	if service == nil {
	...
	environment := model.NewEnvironment(name)
...
func DeleteTestEnvironment(t *testing.T, service *environmentService, artifact *model.Environment) error {
	if service == nil {
		service = createEnvironmentService(t)
	}
	require.NotNil(t, service)
...
func IsEqualEnvironments(t *testing.T, expected *model.Environment, actual *model.Environment) {
...
func UpdateEnvironment(t *testing.T, service *environmentService, environment *model.Environment) *model.Environment {
	if service == nil {
		service = createEnvironmentService(t)
	}
	require.NotNil(t, service)
...
func TestEnvironmentServiceAdd(t *testing.T) {
	...
	resource, err = service.Add(&model.Environment{})
	require.Error(t, err)
	require.Nil(t, resource)
