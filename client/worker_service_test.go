...
func CreateTestWorker(t *testing.T, service *workerService) *model.Worker {
	if service == nil {
	...
	listeningTentacleEndpoint := model.NewListeningTentacleEndpoint(url, thumbprint)
	require.NotNil(t, listeningTentacleEndpoint)

	worker := model.NewWorker(name, listeningTentacleEndpoint)
...
func DeleteTestWorker(t *testing.T, service *workerService, worker *model.Worker) error {
	if service == nil {
		service = createWorkerService(t)
	}
	require.NotNil(t, service)
...
func IsEqualWorkers(t *testing.T, expected *model.Worker, actual *model.Worker) {
...
func UpdateWorker(t *testing.T, service *workerService, worker *model.Worker) *model.Worker {
	if service == nil {
		service = createWorkerService(t)
	}
	require.NotNil(t, service)
...
func TestWorkerServiceAdd(t *testing.T) {
	...
	resource, err = service.Add(&model.Worker{})
	require.Error(t, err)
	require.Nil(t, resource)
