...
func TestDeploymentTargetMarshalJSON(t *testing.T) {
	resource := &machines.ListeningTentacleDeploymentTarget{
		Endpoint:               &machines.ListeningTentacleEndpoint{},
