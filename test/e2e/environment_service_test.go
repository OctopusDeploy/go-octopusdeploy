...
func CreateTestEnvironment(t *testing.T, client *client.Client) *environments.Environment {
	if client == nil {
...
func DeleteTestEnvironment(t *testing.T, client *client.Client, environment *environments.Environment) {
...
func IsEqualEnvironments(t *testing.T, expected *environments.Environment, actual *environments.Environment) {
...
func UpdateEnvironment(t *testing.T, client *client.Client, environment *environments.Environment) *environments.Environment {
	require.NotNil(t, environment)
