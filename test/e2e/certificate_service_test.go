...
func CreateTestCertificateResource(t *testing.T, client *client.Client) *certificates.CertificateResource {
	if client == nil {
...
func DeleteTestCertificateResource(t *testing.T, client *client.Client, certificate *certificates.CertificateResource) {
	require.NotNil(t, certificate)
...
func TestCertificateServiceArchiveUnarchive(t *testing.T) {
	...
	unarchivedCertificate, err := client.Certificates.Unarchive(certificate)
	require.NoError(t, err)
	require.NotNil(t, archivedCertificate)

	archivedCertificate, err = client.Certificates.Archive(unarchivedCertificate)
	require.NoError(t, err)
	require.NotNil(t, archivedCertificate)
