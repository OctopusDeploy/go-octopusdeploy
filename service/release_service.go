...
func (s services.deploymentService) GetDeployments(release *Release, deploymentQuery ...*DeploymentQuery) (*Deployments, error) {
	if release == nil {
...
func (s services.deploymentService) GetProgression(release *Release) (*Progression, error) {
	if release == nil {
		return nil, createInvalidParameterError(OperationGetDeployments, ParameterRelease)
	}
