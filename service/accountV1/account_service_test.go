...
func createAccountService(t *testing.T) *accountService {
	...
	octopusdeploy.testNewService(t, service, octopusdeploy.TestURIAccounts, service.ServiceAccountService)
	return service
}
...
func TestAccountServiceAdd(t *testing.T) {
	...
	require.Equal(t, err, octopusdeploy.createInvalidParameterError(service.OperationAdd, service.ParameterAccount))
...
func TestAccountServiceGetByID(t *testing.T) {
	...
	require.Equal(t, octopusdeploy.createInvalidParameterError(service.OperationGetByID, service.ParameterID), err)
	require.Nil(t, resource)
...
func TestAccountServiceNew(t *testing.T) {
	...
	ServiceName := service.ServiceAccountService
...
func TestAccountServiceParameters(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Error(t, err)
			require.Equal(t, octopusdeploy.createInvalidParameterError(service.OperationDeleteByID, service.ParameterID), err)
		})
	}
}
...
func TestAccountServiceUpdateWithEmptyAccount(t *testing.T) {
	...
	account, err = service.Update(&service.AzureServicePrincipalAccount{})
	require.Error(t, err)
	require.Nil(t, account)
