...
func TestAccountResource(t *testing.T) {
	...
	testCases := []struct {
		...
		{"EmptyName", true, internal.emptyString, spaceID, tenantedDeploymentMode},
		{"WhitespaceName", true, internal.whitespaceString, spaceID, tenantedDeploymentMode},
		{"EmptySpaceID", false, name, internal.emptyString, tenantedDeploymentMode},
		{"WhitespaceSpaceID", true, name, internal.whitespaceString, tenantedDeploymentMode},
	}
