...
func TestAzureServicePrincipalAccount(t *testing.T) {
	...
	applicationPassword := resources.NewSensitiveValue(internal.getRandomName())
	...
	testCases := []struct {
		...
		{"EmptyName", true, &applicationID, applicationPassword, authenticationEndpoint, azureEnvironment, internal.emptyString, resourceManagerEndpoint, spaceID, &subscriptionID, tenantedDeploymentMode, &tenantID},
		{"WhitespaceName", true, &applicationID, applicationPassword, authenticationEndpoint, azureEnvironment, internal.whitespaceString, resourceManagerEndpoint, spaceID, &subscriptionID, tenantedDeploymentMode, &tenantID},
		{"EmptySpaceID", false, &applicationID, applicationPassword, authenticationEndpoint, azureEnvironment, name, resourceManagerEndpoint, internal.emptyString, &subscriptionID, tenantedDeploymentMode, &tenantID},
		{"WhitespaceSpaceID", true, &applicationID, applicationPassword, authenticationEndpoint, azureEnvironment, name, resourceManagerEndpoint, internal.whitespaceString, &subscriptionID, tenantedDeploymentMode, &tenantID},
