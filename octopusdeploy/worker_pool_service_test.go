...
func CreateTestDynamicWorkerPool(t *testing.T, service *workerPoolService) IWorkerPool {
	if service == nil {
	...
	dynamicWorkerPool := NewDynamicWorkerPool(name, workerType)
...
func CreateTestStaticWorkerPool(t *testing.T, service *workerPoolService) IWorkerPool {
	if service == nil {
		service = createWorkerPoolService(t)
	}
	require.NotNil(t, service)
	...
	staticWorkerPool := NewStaticWorkerPool(name)
...
func DeleteTestWorkerPool(t *testing.T, service *workerPoolService, workerPool IWorkerPool) error {
	if service == nil {
		service = createWorkerPoolService(t)
	}
	require.NotNil(t, service)
...
func IsEqualWorkerPools(t *testing.T, expected IWorkerPool, actual IWorkerPool) {
...
func UpdateWorkerPool(t *testing.T, service *workerPoolService, workerPool *WorkerPool) *WorkerPool {
	if service == nil {
		service = createWorkerPoolService(t)
	}
	require.NotNil(t, service)
...
func TestWorkerPoolServiceAdd(t *testing.T) {
	...
	resource, err = service.Add(&WorkerPool{})
	require.Error(t, err)
	require.Nil(t, resource)
