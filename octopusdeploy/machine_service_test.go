...
func CreateTestDeploymentTarget(t *testing.T, service *machineService, name string, environment *Environment) *DeploymentTarget {
	if service == nil {
	...
	deploymentTarget := NewDeploymentTarget(name, endpoint, environmentIDs, roles)
...
func DeleteTestDeploymentTarget(t *testing.T, service *machineService, deploymentTarget *DeploymentTarget) error {
...
func IsEqualDeploymentTargets(t *testing.T, expected *DeploymentTarget, actual *DeploymentTarget) {
...
func TestMachineServiceUpdate(t *testing.T) {
	...
	endpoint, ok := expected.Endpoint.(OfflineDropEndpoint)
	require.True(t, ok)
