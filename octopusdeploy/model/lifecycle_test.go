...
// 	assert.Equal(t, RetentionUnitDays, phase0.ReleaseRetentionPolicy.Unit)
...
// 	assert.Equal(t, RetentionUnitItems, phase0.TentacleRetentionPolicy.Unit)
...
// 	assert.Equal(t, RetentionUnitDays, lifecycle.ReleaseRetentionPolicy.Unit)
...
// 	assert.Equal(t, RetentionUnitItems, lifecycle.TentacleRetentionPolicy.Unit)
