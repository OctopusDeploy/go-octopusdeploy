...
func CreateTestAwsElasticContainerRegistry(t *testing.T, service *feedService) IFeed {
	if service == nil {
	...
	secretKey := NewSensitiveValue("secret-key")
	region := "ap-southeast-2"

	feed := NewAwsElasticContainerRegistry(getRandomName(), accessKey, secretKey, region)
...
func CreateTestGitHubRepositoryFeed(t *testing.T, service *feedService) IFeed {
	if service == nil {
		service = createFeedService(t)
	}
	require.NotNil(t, service)

	feed := NewGitHubRepositoryFeed(getRandomName(), "http://example.com/")
...
func CreateTestHelmFeed(t *testing.T, service *feedService) IFeed {
	if service == nil {
		service = createFeedService(t)
	}
	require.NotNil(t, service)

	feed := NewHelmFeed(getRandomName(), "http://example.com/")
...
func CreateTestMavenFeed(t *testing.T, service *feedService) IFeed {
	if service == nil {
		service = createFeedService(t)
	}
	require.NotNil(t, service)

	feed := NewMavenFeed(getRandomName(), "http://example.com/")
...
func CreateTestNuGetFeed(t *testing.T, service *feedService) IFeed {
	if service == nil {
		service = createFeedService(t)
	}
	require.NotNil(t, service)

	feed := NewNuGetFeed(getRandomName(), "http://example.com/")
...
func DeleteTestFeed(t *testing.T, service *feedService, feed IFeed) error {
	if service == nil {
		service = createFeedService(t)
	}
	require.NotNil(t, service)
...
func IsEqualFeeds(t *testing.T, expected IFeed, actual IFeed) {
