...
func createActionTemplate(t *testing.T) *service.ActionTemplate {
	resource := service.NewActionTemplate(getRandomName(), service.ActionTypeOctopusScript)
	require.NotNil(t, resource)

	resource.Properties = map[string]service.PropertyValue{}
	resource.Properties[service.ActionTypeOctopusActionScriptBody] = service.NewPropertyValue(getRandomName(), false)

	return resource
}

func IsEqualActionTemplates(t *testing.T, expected *service.ActionTemplate, actual *service.ActionTemplate) {
...
func TestActionTemplateServiceAdd(t *testing.T) {
	...
	invalidResource := &service.ActionTemplate{}
