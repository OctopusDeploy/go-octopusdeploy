...
const (
	...
	TestURICertificates                      string = "/api/certificates{/id}{?skip,take,search,archived,tenant,firstResult,orderBy,ids,partialName}"
	TestURIChannels                          string = "/api/channels{/id}{?skip,take,ids,partialName}"
	...
	TestURIDeployments                       string = "/api/deployments{/id}{?skip,take,ids,projects,environments,tenants,channels,taskState,partialName}"
	...
	TestURIMachinePolicies                   string = "/api/machinepolicies{/id}{?skip,take,ids,partialName}"
	TestURIMachinePolicyTemplate             string = "/api/machinepolicies/template"
	...
	TestURIRunbookProcesses                  string = "/api/runbookProcesses{/id}{?skip,take,ids}"
