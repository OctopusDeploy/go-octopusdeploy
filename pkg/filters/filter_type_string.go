...
const _FilterTypeName = "ContinuousDailyScheduleCronExpressionScheduleDailyScheduleDaysPerMonthScheduleDaysPerWeekScheduleMachineFilterOnceDailyScheduleFeedFilter"

var _FilterTypeIndex = [...]uint8{0, 23, 45, 58, 78, 97, 110, 127, 137}

const _FilterTypeLowerName = "continuousdailyschedulecronexpressionscheduledailyscheduledayspermonthscheduledaysperweekschedulemachinefilteroncedailyschedulefeedfilter"
...
var _FilterTypeValues = []FilterType{ContinuousDailySchedule, CronExpressionSchedule, DailySchedule, DaysPerMonthSchedule, DaysPerWeekSchedule, MachineFilter, OnceDailySchedule, FeedFilter}
