...
func Get(client newclient.Client, spaceID string, environmentsV2Query EnvironmentQuery) (*resources.Resources[*Environment], error) {
	return newclient.GetByQuery[Environment](client, v2.Template, spaceID, environmentsV2Query)
}
